...
public class ReconnectionExcludesFeatureConstraintFeature extends DefaultReconnectionFeature {
	 
    public ReconnectionExcludesFeatureConstraintFeature(IFeatureProvider fp) {
        super(fp);
    }
