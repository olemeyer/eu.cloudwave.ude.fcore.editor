...
public class ReconnectionMandatoryConnectionFeature extends DefaultReconnectionFeature {
	 
    public ReconnectionMandatoryConnectionFeature(IFeatureProvider fp) {
        super(fp);
    }
