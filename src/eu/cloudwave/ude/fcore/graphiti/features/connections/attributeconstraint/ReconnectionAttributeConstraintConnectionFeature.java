...
public class ReconnectionAttributeConstraintConnectionFeature extends DefaultReconnectionFeature {
	 
    public ReconnectionAttributeConstraintConnectionFeature(IFeatureProvider fp) {
        super(fp);
    }
    	...
    	if (context.getTargetPictogramElement() instanceof Shape) {
    		...
    		ret = (connection != null)
    				...
    				&& ((type.equals(ReconnectionContext.RECONNECT_SOURCE) && bo instanceof Feature)
    						|| (type.equals(ReconnectionContext.RECONNECT_TARGET) && bo instanceof AttributeConstraint));
    	}
		return ret;
    }
