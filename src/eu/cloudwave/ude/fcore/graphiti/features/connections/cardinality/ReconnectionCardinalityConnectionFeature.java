...
public class ReconnectionCardinalityConnectionFeature extends DefaultReconnectionFeature {
	 
    public ReconnectionCardinalityConnectionFeature(IFeatureProvider fp) {
        super(fp);
    }
