...
public class ReconnectionFeatureToGroupConnectionFeature extends DefaultReconnectionFeature {
	 
    public ReconnectionFeatureToGroupConnectionFeature(IFeatureProvider fp) {
        super(fp);
    }
    ...
    public boolean canReconnect(IReconnectionContext context) {
		...
		ret = (connection != null)
				...
				|| (type.equals(ReconnectionContext.RECONNECT_TARGET) && bo instanceof FeatureGroup));
    	}
		return ret;
    }
