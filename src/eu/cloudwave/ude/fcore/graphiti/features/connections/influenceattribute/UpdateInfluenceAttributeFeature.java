...
public class UpdateInfluenceAttributeFeature extends AbstractUpdateFeature {

	public UpdateInfluenceAttributeFeature(IFeatureProvider fp) {
        super(fp);
    }
 
    public boolean canUpdate(IUpdateContext context) {
        // return true, if linked business object is a InfluenceAttribute
        Object bo =
            getBusinessObjectForPictogramElement(context.getPictogramElement());
        return (bo instanceof InfluenceAttribute);
    }
    ...
    public IReason updateNeeded(IUpdateContext context) {
        ...
        if (bo instanceof InfluenceAttribute) {
        	InfluenceAttribute influenceAttribute = (InfluenceAttribute) bo;
            businessContribution = influenceAttribute.getContribution();
        }
