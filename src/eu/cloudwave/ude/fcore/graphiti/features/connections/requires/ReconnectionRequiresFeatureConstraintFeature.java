...
public class ReconnectionRequiresFeatureConstraintFeature extends DefaultReconnectionFeature {
	 
    public ReconnectionRequiresFeatureConstraintFeature(IFeatureProvider fp) {
        super(fp);
    }
