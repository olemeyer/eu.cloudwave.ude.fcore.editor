...
public class FCoreFeatureGroupSection extends GFPropertySection implements ITabbedPropertyConstants {
	...
	public FCoreFeatureGroupSection() {
		setOlds = true;
	}
				...
				if (minText.getText().matches(regex) && maxText.getText().matches(regex)) {
					...
					if (minValue <= maxValue & minValue >= 0) {
						...
						if (pe != null) {
							...
							if (bo == null)
								return;
							int min = ((FeatureGroup) bo).getMin();
							if (minValue == min)
								return;
						}
						...
						IFeature feature = new AbstractFeature(getDiagramTypeProvider().getFeatureProvider()) {
							...
							public void execute(IContext context) {
								...
								if (pe != null) {
									...
									featureGroup.setMin(typedValue);
									oldMin = typedValue;
								}
							}
				...
				if (minText.getText().matches(regex) && maxText.getText().matches(regex)) {
					...
					if (minValue <= maxValue & minValue >= 0) {
						...
						if (pe != null) {
							...
							if (bo == null)
								return;
							int max = ((FeatureGroup) bo).getMax();
							if (maxValue == max)
								return;
						}
							...
							public void execute(IContext context) {
								...
								if (pe != null) {
									...
									if (bo == null)
										return;
									FeatureGroup featureGroup = (FeatureGroup) bo;
									featureGroup.setMax(typedValue);
									oldMax = typedValue;
								}
							}
